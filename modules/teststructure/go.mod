module github.com/gruntwork-io/terratest/modules/teststructure/v2
...
require (
	...
	github.com/gruntwork-io/terratest/modules/opa/v2 v2.0.0-beta.2
...
require (
	...
	github.com/gruntwork-io/terratest/modules/ssh/v2 v2.0.0-beta.2 // indirect
