...
func TestFetchRecoveryServicesVault_Success(t *testing.T) {
	...
	vault, err := fetchRecoveryServicesVault(t.Context(), client, "rg", "testvault")
...
func TestFetchRecoveryServicesVault_NotFound(t *testing.T) {
	...
	client := newFakeVaultsClient(t, srv)
	_, err := fetchRecoveryServicesVault(t.Context(), client, "rg", "missing")
...
func TestCollectBackupPolicies_OnePage(t *testing.T) {
	...
	policies, err := collectBackupPolicies(t.Context(), client, "vault", "rg")
...
func TestCollectBackupProtectedVMs_WithVMItems(t *testing.T) {
	...
	vms, err := collectBackupProtectedVMs(t.Context(), client, "vault", "rg", "policy1")
